...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(795225061U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1179709690U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3144177455U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(777355116U);
}
...
mxArray *sf_c5_TST_SATELLITE_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("1cfZMLchVHK0busQgJOL3");
...
static void mdlSetWorkWidths_c5_TST_SATELLITE(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(258925979U));
  ssSetChecksum1(S,(153715693U));
  ssSetChecksum2(S,(3175231585U));
  ssSetChecksum3(S,(4140467700U));
