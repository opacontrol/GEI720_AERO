...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3068327314U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(78635418U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1780939544U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2810716158U);
}
...
mxArray *sf_c3_TST_SATELLITE_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("Ty0uMLdounNb9VhGBmpIQG");
...
static void mdlSetWorkWidths_c3_TST_SATELLITE(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(4171485446U));
  ssSetChecksum1(S,(4287103042U));
  ssSetChecksum2(S,(737278230U));
  ssSetChecksum3(S,(2768107389U));
